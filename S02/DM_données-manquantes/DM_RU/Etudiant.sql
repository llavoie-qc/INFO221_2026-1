...
begin
  ...
  then
    ...
    raise exception 'Exclusion non respectée entre Etudiant_RU_avec_adresse et Etudiant_RU_sans_adresse' ;
    return null ;
  end if ;
end
$$ ;
...
create view Etudiant_PJ_table_NULL (matricule, nom, adresse) as
  ...
  union
  select matricule, nom, null as adresse from Etudiant_RU_sans_adresse
;
